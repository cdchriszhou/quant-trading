      ...
      <el-card shadow="never">
        ...
        <el-form label-width="80px" size="small">
          <el-form-item label="标的">
            <el-select v-model="form.symbol" filterable allow-create default-first-option style="width: 100%">
    ...
    <el-col :span="16">
      <el-card shadow="never">
        ...
        <el-row :gutter="12" v-if="account">
          <el-col :span="8" v-for="(item, idx) in accountItems" :key="idx">
...
const accountItems = computed(() => {
  ...
  return [
    ...
    { label: '累计盈亏', value: `¥${(a.total_pnl || 0).toLocaleString()}` },
    { label: '持仓数量', value: `${a.position_count || 0}` },
